...
void Pobeda()
    ...
    for (int t = 10; t <= 100; t += 15)
        ...
        txSetColor (TX_WHITE);
        txSelectFont ("Arial Black", 30);
        txTextOut (150, 550, "Íàäî ñòðîèòü çàáîð!");
        txSleep (300);
        }
...
void FinishTitles()
    ...
    while (t <= 400)
        ...
        txTextOut (200, 1000 - t*2, "Ìóëüòôèëüì ïîäãîòîâèëà");
        txTextOut (290, 1050 - t*2, "Æàäîáèíà Åëåíà");
        txTextOut (300, 1100 - t*2, "ã. Ìàãíèòîãîðñê");
        txTextOut (320, 1150 - t*2, "ÌÀÎÓ ÌË ¹1");
        txSleep (100);
        t+= 5;
        }
